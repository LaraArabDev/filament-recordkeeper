...
class InstallCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        if (class_exists(\Filament\Panel::class)) {
            ...
            $this->line('');
            $this->line('  RecordkeeperPlugin::make()');
            $this->line('      ->enableRollback()');
            $this->line('      ->enableTimeline()');
            $this->line('      ->enableStatsWidget()');
            $this->line('      ->navigationGroup(\'Audit\'),');
        } else {
            $this->info('Headless mode (no Filament). Quick start:');
            $this->line('');
            $this->line('  #[Auditable]');
