...
use LaraArabDev\Recordkeeper\Listeners\RecordCustomContext;
...
{
    #[Test]
    public function record_custom_context_handle_is_noop(): void
    {
        $order = Order::create(['status' => 'pending']);
        $audit = Audit::first();

        $listener = new RecordCustomContext;
        $listener->handle(new ChangeRecorded($audit));
